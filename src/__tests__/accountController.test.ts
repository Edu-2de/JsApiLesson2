...
describe('AccountController', () => {
  ...
  describe('closeAccount', () => {
    ...
    it('should be return 400 if account is already closed', async () => {
      mockReq.account = { id: 1 };
      const mockAccount = {
        id: 1,
        balance: 0.0,
      ...
      expect(mockRes.status).toHaveBeenCalledWith(400);
      expect(mockRes.json).toHaveBeenCalledWith({ error: 'This account is already closed!' });
    });
  ...
  describe('activeAccountId', () => {
    it('should be return 404 if account not exists', async () => {
      ...
      await AccountController.activeAccountId(mockReq, mockRes);
